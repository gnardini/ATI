...
harrisPercentage = Scale(root, from_=0, to=1, resolution=0.01, orient=HORIZONTAL)
harrisPercentage.set(0.05)
harrisPercentage.grid(row=11, column=1)
harrisThreshold = Scale(root, from_=0, to=100000000, resolution=100000, orient=HORIZONTAL)
harrisThreshold.set(10000000)
harrisThreshold.grid(row=11, column=2)
harrisK = Scale(root, from_=0.04, to=0.06, resolution=0.01, orient=HORIZONTAL)
harrisK.set(0.04)
harrisK.grid(row=11, column=3)
