...
scalarScale = Scale(root, from_=1, to=10, resolution=0.5, orient=HORIZONTAL)
scalarScale.set(1.5)
scalarScale.grid(row=0, column=5)
btn = Button(root, text='Multiplica constante', command=lambda: put_into('result-up', ops.multiply_by_scalar(images['original-up'], scalarScale.get()), tr.mapping.DYNAMIC))
